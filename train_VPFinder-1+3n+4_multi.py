...
best_f1_path = "model_best/VPFinder-1+3n+4_multi_f1.txt"
best_model_path = "model_best/VPFinder-1+3n+4_multi_model.pth"
...
with open("data/cwe_1_8_classes_old.json", 'r') as f:
    content = f.read()
...
with open("data/cwe_2_4_classes_old.json", 'r') as f:
    content = f.read()
