...
best_f1_path = "model_best/VPFinder-S_multi_f1.txt"
best_model_path = "model_best/VPFinder-S_multi_model.pth"
...
class MultiClassifier(nn.Module):
    ...
    def forward(self, del_id, add_id, message_id, del_mask, add_mask, message_mask, vul_label_first_layer, vul_label_second_layer):
        ...
        hidden_output = self.hidden(solution_output)
...
def train_multi_model(model, train_data, val_data, learning_rate, epochs):
    ...
    for epoch in range(epochs):
        ...
        for delete, add, messages, labels in tqdm(train_dataloader):
            ...
            outputs, preds = model(del_ids, add_ids, message_ids, del_mask, add_mask, message_mask, vul_label_first_layer, vul_label_second_layer)
