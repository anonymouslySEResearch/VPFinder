...
best_f1_path = "model_best/VPFinder-c_binary_f1.txt"
best_model_path = "model_best/VPFinder-c_binary_model.pth"
...
class VulClassifier(nn.Module):
    ...
    def forward(self, sample_id, sample_mask):
        pooled_output = self.bert1.roberta(input_ids=sample_id, attention_mask=sample_mask, return_dict=False)[0]
