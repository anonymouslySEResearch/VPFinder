...
class VulClassifier(nn.Module):
    ...
    def forward(self, del_sample_id, add_sample_id, del_sample_mask, add_sample_mask):
        pooled_output_del = \
        self.bert1.roberta(input_ids=del_sample_id, attention_mask=del_sample_mask, return_dict=False)[0]
        pooled_output_add = \
        self.bert1.roberta(input_ids=add_sample_id, attention_mask=add_sample_mask, return_dict=False)[0]
