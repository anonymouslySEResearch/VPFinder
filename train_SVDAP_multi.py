...
# Load data
df = pd.read_csv("data_final/dataset_project_relation_layer.csv", low_memory=False)
...
def train(model, train_data, val_data, learning_rate, epochs):
    ...
    for epoch in range(epochs):
        ...
        for messages, adds, dels, labels in tqdm(train_dataloader):
...
train(model, filtered_df_train, filtered_df_test, LR, EPOCHS)